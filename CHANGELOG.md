...
### Changed
- Replace the capped My Workload preview with a focusable, vertically scrollable table
  showing every active array.
- Add direct `1`, `2`, and `3` shortcuts for focusing Nodes, Jobs, and My Workload,
  avoiding terminal-dependent Shift key combinations.

### Fixed
- Make the previously hidden arrays behind `+N more` reachable with `j`/`k` scrolling.
...
[Unreleased]: https://github.com/RuHae/smon/compare/v0.5.4...HEAD
[0.5.4]: https://github.com/RuHae/smon/compare/v0.5.3...v0.5.4
