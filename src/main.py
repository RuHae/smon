...
def copy_to_clipboard(text):
    """
    Copies text to the LOCAL clipboard using OSC 52 escape sequences.
    Works over SSH with modern terminals (iTerm2, Windows Terminal, Alacritty, VSCode).
    """
    try:
        # Encode text to Base64
        data = base64.b64encode(text.encode("utf-8")).decode("utf-8")
        # OSC 52 sequence: \x1b]52;c;{data}\x07
